  ...
  describe "#all_of_type" do
    ...
    it "returns all, arbitrarily-nested nodes matching the given type" do
      sexp = s(:block,
               ...
               s(:return, s(:lvar, :b)))
      matches = wrap(sexp).all_of_type(:lvar)
